            ...
            <div className="relative max-w-7xl mx-auto px-4 py-12">
                ...
                <div className="text-center max-w-3xl mx-auto mb-16">
                    <motion.div
                        ...
                        className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-gradient-to-r from-blue-500/10 
                        to-purple-500/10 text-sm text-gray-400 mb-6"
                    >
                ...
                <div className="relative max-w-5xl mx-auto mb-12 space-y-6">
                    ...
                    <div className="flex flex-wrap items-center gap-4">
                        ...
                        {popularLanguages.map((lang) => (
                            <button
                                key={lang} onClick={() => setSelectedLanguage(lang === selectedLanguage ? null : lang)}
                                className={`group relative px-3 py-1.5 rounded-lg transition-all duration-200 
                                    ${selectedLanguage === lang
                                        ...
                                        : `text-gray-400 hover:text-gray-300 bg-[#1e1e2e] hover:bg-[#262637] 
